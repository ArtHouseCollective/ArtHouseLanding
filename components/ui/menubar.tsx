...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:slide-out-to-left-1 data-[state=closed]:slide-out-to-top-1 data-[state=open]:zoom-in-95 data-[state=open]:slide-in-from-left-1 data-[state=open]:slide-in-from-top-1",
      className,
    )}
    {...props}
  />
