...
const FormField = ({
  ...
  return <Controller name={props.name} render={props.render} />
}
...
function useFormField() {
  ...
  const fieldState = getFieldState(fieldContext?.id || "")
  ...
  return {
    ...
    ...fieldState,
    isDirty: fieldState.isDirty || formState.dirtyFields[fieldContext.id],
    isTouched: fieldState.isTouched || formState.touchedFields[fieldContext.id],
