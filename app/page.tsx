            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {features.map((feature, index) => (
                <div key={index} className="flex flex-col items-center text-center">
                  ...
                  <Card className="w-full h-[200px] relative overflow-hidden rounded-lg shadow-lg bg-gray-900 border border-gray-700">
                    {feature.image && (
                    ...
                    <CardContent className="relative z-10 flex flex-col items-center justify-center h-full p-4">
                      {feature.type === "text" ? (
